...
- شماره منازل ۷ گانه قرآن به صورت اعداد ساده پیش از سوره‌های مربوطه درج می‌شود.
...
# تغییر کلیدی: استفاده از اعداد استاندارد (ASCII)
# فونت عثمان طه این اعداد را به صورت عدد عربی ساده (بدون گل آیه) نمایش می‌دهد
MANZIL_STARTS = {
    1: "1",   # منزل اول: الفاتحه تا النساء
    5: "2",   # منزل دوم: المائده تا التوبه
    10: "3",  # منزل سوم: یونس تا النحل
    17: "4",  # منزل چهارم: الاسراء تا الفرقان
    26: "5",  # منزل پنجم: الشعراء تا یس
    37: "6",  # منزل ششم: الصافات تا الحجرات
    50: "7"   # منزل هفتم: ق تا الناس
}
...
def main():
    ...
    for num, path in files:
        ...
        # اگر سوره، سوره ابتدای یک منزل است، ابتدا شماره ساده منزل را به لیست اضافه می‌کنیم
